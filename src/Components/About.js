    ...
    <div className="cube__face cube__face--about">
      <div className="about">
        ...
        <p className="about__text">
          I'm a full stack software engineer from the Boston area. I previously
          have a background working with special needs people for about 8 years.
          My coding journey started back in October 2018. Coding went from a
          hobby that I enjoyed to me considering making a career change farily
